...
import { BidCalculationRequest, BidCalculationResponse } from 'src/app/models/bidcalculator.model';

@Component({
  selector: 'app-bidcalculator',
  templateUrl: './bidcalculator.component.html',
  styleUrls: ['./bidcalculator.component.scss']
})
  ...
  getCalculationResponse() {
    ...
    if (this.calculationfrm.invalid) {
      ...
      let body: BidCalculationRequest = {
        ...
        vehicleType: this.calculationfrm.value.vehicleType,
      };
